...
export const IndividualReport = ({ learner, classAverage }: IndividualReportProps) => {
  ...
  return (
    <div className="print-page bg-white text-black">
      ...
      <div className="border-2 border-gray-800 p-1.5 h-full flex flex-col">
      {/* Header with Logo */}
      <div className="relative mb-1.5 border-b-2 border-gray-800 pb-1.5">
      ...
      <div className="mb-1.5">
        <Card className="p-1.5 bg-gray-50 border-2 border-gray-300">
      ...
      <div className="mb-1.5 flex-1">
        <h2 className="text-[10px] font-bold mb-1 border-b border-gray-400 pb-0.5">Subject Performance</h2>
        <div className="space-y-0.5">
          {subjects.map((subject, index) => (
            <div 
              key={index} 
              className="grid grid-cols-[1fr_auto_auto_auto_1fr] gap-3 items-center p-0.5 bg-gray-50 border border-gray-300 rounded text-[9px]"
            >
              <span className="font-medium">{subject.label}</span>
              <span className="font-bold text-center w-8">{subject.value || 0}</span>
              <span className="font-bold text-center w-8 bg-primary text-white rounded px-0.5">
                {getGrade(subject.value)}
              </span>
              <span className="font-bold text-center w-8 bg-secondary text-secondary-foreground rounded px-0.5">
      ...
      <div className="mb-1.5">
        <Card className="p-1.5 bg-gray-50 border-2 border-gray-300">
          <h3 className="text-[10px] font-bold mb-1">Performance Summary</h3>
      ...
      <div className="mb-1.5">
        <Card className="p-1.5 bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-indigo-200">
          <h3 className="text-[10px] font-bold mb-1 text-indigo-900 border-b border-indigo-200 pb-0.5">Student Assessment</h3>
          <div className="grid grid-cols-2 gap-1.5">
            <div className="bg-white rounded-lg p-1.5 border border-indigo-100 shadow-sm">
              <p className="text-[9px] font-semibold text-indigo-600 mb-0.5 uppercase tracking-wide">Conduct</p>
              <p className="text-xs font-bold text-gray-800">{learner.conduct || "Not Set"}</p>
            </div>
            <div className="bg-white rounded-lg p-1.5 border border-indigo-100 shadow-sm">
              <p className="text-[9px] font-semibold text-indigo-600 mb-0.5 uppercase tracking-wide">Interest</p>
              <p className="text-xs font-bold text-gray-800">{learner.interest || "Not Set"}</p>
            </div>
            <div className="bg-white rounded-lg p-1.5 border border-indigo-100 shadow-sm">
              <p className="text-[9px] font-semibold text-indigo-600 mb-0.5 uppercase tracking-wide">Attendance</p>
            ...
            <div className="bg-white rounded-lg p-1.5 border border-indigo-100 shadow-sm">
              <p className="text-[9px] font-semibold text-indigo-600 mb-0.5 uppercase tracking-wide">Promotion Status</p>
              <p className="text-xs font-bold text-gray-800">{learner.status || "Not Set"}</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      {learner.teacherRemark && (
        <div className="mb-1.5">
          <Card className="p-1.5 bg-gradient-to-br from-amber-50 to-yellow-50 border-2 border-amber-200">
            <h3 className="text-[10px] font-bold mb-1 text-amber-900 border-b border-amber-200 pb-0.5">Class Teacher&apos;s Remark</h3>
            <p className="text-[9px] leading-relaxed text-gray-800 bg-white rounded-lg p-1.5 border border-amber-100">{learner.teacherRemark}</p>
          </Card>
        </div>
      )}

      {/* Footer */}
      <div className="pt-1.5 border-t-2 border-gray-300 mt-auto">
        <div className="grid grid-cols-3 gap-4">
          <div>
            <p className="mb-1 text-[9px]">Class Teacher&apos;s Signature:</p>
            <div className="border-b-2 border-gray-400 w-24"></div>
          </div>
          <div>
            <p className="mb-1 text-[9px]">Headteacher&apos;s Signature:</p>
            <div className="border-b-2 border-gray-400 w-24"></div>
          </div>
          <div>
            <p className="mb-1 text-[9px]">Date:</p>
            <div className="border-b-2 border-gray-400 w-24"></div>
          </div>
        </div>
      </div>
